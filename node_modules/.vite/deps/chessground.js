...
var canPremove = (state, orig, dest) => orig !== dest && isPremovable(state, orig) && premove(state.pieces, orig, state.premovable.castle).includes(dest);
...
function renderShape(state, { shape, current, hash: hash2 }, brushes2, arrowDests, bounds) {
  ...
  if (shape.customSvg) {
    ...
    if (shape.dest) {
      ...
      el = renderCircle(brushes2[shape.brush], orig, current, bounds);
  }
